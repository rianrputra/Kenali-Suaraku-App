...
public class QuizLima extends AppCompatActivity {
    int opsi = 0;
    int skor;
    int buttonPilih = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_lima);
    ...
    public void pilihJawaban(View view) {
        ...
        if (buttonPilih == 0){
            if (opsi == 1){
                ...
                Button pilih = findViewById(R.id.buttonPilih);
                pilih.setVisibility(View.GONE);
                ImageButton benerBro = findViewById(R.id.imgBtnSatu);
                ...
                Button lanjut = findViewById(R.id.buttonLanjut);
                lanjut.setVisibility(View.VISIBLE);
                ImageButton salahBro = findViewById(R.id.imgBtnDua);
    ...
    public void lanjutQuiz(View view) {
        final Intent intent = new Intent(this, ScoreCounting.class);
        Bundle b = new Bundle();
        b.putInt("skor", skor);
        intent.putExtras(b);
    ...
    public void playAudio(View view) {
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.duck_sound);
        mp.start();
    }
