...
public class QuizTiga extends AppCompatActivity {
    int opsi = 0;
    int skor;
    int buttonPilih = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_tiga);
    ...
    public void pilihJawaban(View view) {
        ...
        if (buttonPilih == 0){
            if (opsi == 3){
                ...
                Button pilih = findViewById(R.id.buttonPilih);
                pilih.setVisibility(View.GONE);
                ImageButton benerBro = findViewById(R.id.imgBtnTiga);
    ...
    public void lanjutQuiz(View view) {
        final Intent intent = new Intent(this, QuizEmpat.class);
        Bundle b = new Bundle();
        b.putInt("skor", skor);
        intent.putExtras(b);
    ...
    public void playAudio(View view) {
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.cow_sound);
        mp.start();
    }
