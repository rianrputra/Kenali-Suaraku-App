...
public class QuizSatu extends AppCompatActivity {
    int opsi = 0;
    int skor = 0;
    int buttonPilih = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_satu);

        Typeface custom_font = Typeface.createFromAsset(getAssets(), "fonts/ComicSansMSRegular.ttf");

        ImageView tekan = findViewById(R.id.tekanImage);
    ...
    public void lanjutQuiz(View view) {
        final Intent intent = new Intent(this, QuizDua.class);
        Bundle b = new Bundle();
        b.putInt("skor", skor);
        intent.putExtras(b);
    ...
    public void playAudio(View view) {
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.cat_sound);
        mp.start();
        ImageView tekan = findViewById(R.id.tekanImage);
