...
public class QuizDua extends AppCompatActivity {
    int opsi = 0;
    int skor;
    int buttonPilih = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_dua);
    ...
    public void lanjutQuiz(View view) {
        final Intent intent = new Intent(this, QuizTiga.class);
        Bundle b = new Bundle();
        b.putInt("skor", skor);
        intent.putExtras(b);
    ...
    public void playAudio(View view) {
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.dog_sound);
        mp.start();
    }
